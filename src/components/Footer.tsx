                ...
                <Grid container>
                  <Grid item>
                    <img
                      ...
                      src={process.env.PUBLIC_URL + "icons/f_phone.svg"}
                    />
                  </Grid>
                  <Grid item>
              ...
              <Grid item className={classes.footItem}>
                <Grid container>
                  <Grid item>
                    <img
                      className={classes.footIcon}
                      src={process.env.PUBLIC_URL + "icons/f_call.svg"}
                    />
                  </Grid>
                  <Grid item>
                    <a href="#" target="_blank" className={classes.footLink}>
              ...
              <Grid item>
                <Grid container>
                  <Grid item>
                    <img
                      className={classes.footIcon}
                      src={process.env.PUBLIC_URL + "icons/f_mail.svg"}
                    />
                  </Grid>
                  <Grid item>
                    <a
                      href="https://www.bcc.kz/about/o-banke/"
                      target="_blank"
                ...
                <Grid container>
                  <Grid item>
                    ...
                    >
                      <img
                        ...
                        src={process.env.PUBLIC_URL + "icons/ig.svg"}
                      />
                    </a>
                  </Grid>
                  <Grid item>
                  ...
                  <Grid item>
                    <a href="https://vk.com/centercredit" target="_blank">
                      <img
                        className={classes.footIconSocial}
                        src={process.env.PUBLIC_URL + "icons/vk.svg"}
                      />
                    </a>
                  </Grid>
                </Grid>
